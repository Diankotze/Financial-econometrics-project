...
```
Then to plot the pre-crisis volatility
```{r pre-volatility plot}
# Now the volatility(sigma) of each of the countries is graphed in one single plot
...
```
and... plotting the post-crisis volatility
