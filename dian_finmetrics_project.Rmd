...
sum_stat_table <- xtable(sum_stat_table, caption = "Summary statistics: Bond Yields \\label{tablestats}")
...
library(xtable)
sum_stat_table <- xtable(sum_stat_table, caption = "Summary statistics post crisis: Bond Yields \\label{tablestats2}")
print.xtable(sum_stat_table, 
             tabular.environment = "longtable",
             floating = FALSE,
             table.placement = 'H', 
